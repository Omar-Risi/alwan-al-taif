...
const resources = {
  en: {
    translation: {
      ...
      admissionFormTitle: "Admission Application Form",
      ...
      remarksPlaceholder: "Any additional remarks",
      ...
      previousSchoolQuestion: "Has the child studied elsewhere before?",
      previousSchoolPlaceholder: "Previous school name (if any)",

      // Parent Information
      fatherInfo: "Father's Information",
      motherInfo: "Mother's Information",
      relativeInfo: "Relative Information",
      ...
      relativePhoneLabel: "Relative Phone",
      ...
      submitSuccessSubtitle: "You will be redirected to the homepage...",
      submissionError: "Error submitting application: {{message}}",
      parentSignature: "Parent Signature",
      managementSignature: "Management Signature",

      // Transport and Home
      transportHomeTitle: "Transport and Home Data",
      regionLabel: "Region",
      villageNoLabel: "Village Number",
      houseNumberLabel: "House Number",
      siteDescriptionLabel: "Location Description or Landmark",
      siteDescriptionPlaceholder: "Site description",
      schoolTransportTitle: "School Transport",
      schoolTransportLabel: "School Transport",
      ...
      tripTwoWay: "Two-way trip",
      tripToSchool: "To school only",
      tripFromSchool: "From school only",
      yes: "Yes",
      no: "No",
      ...
      admissionNotFound: "Application not found",
      backToApplications: "Back to applications list",
      actionsTitle: "Actions",
      acceptApplication: "Accept Application",
      rejectApplicationLabel: "Reject Application",
      applicantTitle: "Admission Application",
      submittedAt: "Submitted on",
      studentInfoDetails: "Student Information",
      religion: "Religion",
      tribe: "Tribe",
      ...
      noApplicationsFoundText: "No matching applications found",
      printLabel: "Print",
  ...
  ar: {
    translation: {
      ...
      admissionFormTitle: "استمارة طلب تسجيل",
      ...
      tribeNameLabel: "اسم القبيلة",
      religionLabel: "الديانة",
      remarksLabel: "ملاحظات",
      remarksPlaceholder: "أي ملاحظات إضافية",
      ...
      previousEducationTitle: "التعليم السابق",
      previousSchoolQuestion: "هل درس الطفل في مكان آخر من قبل؟",
      previousSchoolPlaceholder: "اسم المدرسة السابقة (إن وجدت)",

      // Parent Information
      fatherInfo: "معلومات ولي الأمر (الأب)",
      motherInfo: "معلومات ولي الأمر (الأم)",
      relativeInfo: "معلومات قريب",
      ...
      relativePhoneLabel: "رقم هاتف القريب",
      ...
      submitSuccessSubtitle: "سيتم تحويلك إلى الصفحة الرئيسية...",
      submissionError: "حدث خطأ أثناء إرسال الطلب: {{message}}",
      parentSignature: "توقيع ولي الأمر",
      managementSignature: "توقيع الإدارة",

      // Transport and Home
      transportHomeTitle: "بيانات النقل والمنزل",
      regionLabel: "المنطقة",
      villageNoLabel: "رقم القرية",
      houseNumberLabel: "رقم المنزل",
      siteDescriptionLabel: "وصف الموقع أو أي معلم",
      siteDescriptionPlaceholder: "وصف الموقع",
      schoolTransportTitle: "النقل المدرسي",
      schoolTransportLabel: "النقل المدرسي",
      transportTypeLabel: "نوع النقل",
      transportTypePlaceholder: "نوع النقل",
      tripTypeLabel: "نوع الرحلة",
      selectTripType: "اختر نوع الرحلة",
      tripTwoWay: "رحلة ذهاب وعودة",
      tripToSchool: "إلى المدرسة فقط",
      tripFromSchool: "من المدرسة فقط",
      yes: "نعم",
      no: "لا",
      ...
      chooseMediaFiles: "اختر الصور أو الفيديوهات",
      clickToSelectFiles: "اضغط لاختيار الملفات",
      canSelectMultiple: "يمكنك اختيار عدة صور أو فيديوهات",
      totalSize: "إجمالي الحجم",
      someLargeFiles: "بعض الملفات أكبر من 50 ميجابايت. يرجى ضغطها قبل الرفع.",
      compressLargeFiles: "ضغط الملفات الكبيرة",
      compressing: "جاري الضغط...",
      selectedFiles: "الملفات المحددة",
      video: "فيديو",
      image: "صورة",
      compressionFailed: "فشل الضغط",
      loadCompressorFailed: "فشل تحميل أداة الضغط",
      unsupportedFileType: "نوع الملف غير مدعوم",
      compressionSuccess: "تم الضغط بنجاح! تم توفير",
      ofSpace: "من المساحة",
      pleaseSelectFile: "الرجاء اختيار ملف واحد على الأقل",
      filesNeedCompression: "بعض الملفات أكبر من 50 ميجابايت. يرجى ضغطها أولاً.",
      uploadFailed: "فشل رفع",
      ...
      maximumIs50MB: "الحد الأقصى 50 ميجابايت",
      noFileProvided: "لم يتم تقديم ملف",
      cannotCompressVideo: "لا يمكن ضغط الفيديو تحت 50 ميجابايت. الحجم النهائي",

      // Admissions Dashboard
      admissionsManagement: "إدارة طلبات التسجيل",
      admissionsSubtitle: "إدارة ومراجعة طلبات التسجيل المقدمة",
      admissionsLoading: "جاري التحميل...",
      admissionNotFound: "الطلب غير موجود",
      backToApplications: "العودة إلى قائمة الطلبات",
      actionsTitle: "إجراءات",
      acceptApplication: "قبول الطلب",
      rejectApplicationLabel: "رفض الطلب",
      applicantTitle: "طلب التسجيل",
      submittedAt: "تاريخ التقديم",
      studentInfoDetails: "معلومات الطالب",
      religion: "الديانة",
      tribe: "القبيلة",
      fatherName: "اسم الأب",
      grandfatherName: "اسم الجد",
      workPhone: "رقم هاتف العمل",
      relativeName: "اسم القريب",
      relativePhone: "رقم هاتف القريب",
      transportType: "نوع النقل",
      tripType: "نوع الرحلة",
      yesLabel: "نعم",
      noLabel: "لا",
      applicationStatusPending: "قيد المراجعة",
      applicationStatusApproved: "مقبول",
      applicationStatusRejected: "مرفوض",
      noApplicationsFoundText: "لا توجد طلبات مطابقة للبحث",
      printLabel: "طباعة",
